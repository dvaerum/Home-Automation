...
//                System.out.println("WARNING: INCORRECT FUNCTION PARAMETER!: " + currCtx.getText());
    ...
    public Type visitClasses(@NotNull HOMEParser.ClassesContext ctx)
    {
        ...
        return new Type("Error", "Undefined Class");
    }
...
//        System.out.println("\t" + returnType);
    ...
    //TODO: Indeksering(Done for lister, dictionary ikke tjekket.v  Vent pÆ’Ã†â€™Ãƒâ€šÃ‚Ã¥ collection)
    //TODO: Klasser
    //TODO: Lav bedre error message til metodekald, nÆ’Ã†â€™Ãƒâ€šÃ‚Ã¥r en variabel ikke er blevet deklareret[Vent pÆ’Ã†â€™Ãƒâ€šÃ‚Ã¥ Dennis' listener]
    //TODO: Beslut: passing by references vs value
    //TODO: Methods on collection[venter pÆ’Ã†â€™Ãƒâ€šÃ‚Ã¥ Frederik]
    ...
    // --------- Til 2. iteration --------
    //TODO: [lav prioritet]del visitExpression op, sÃƒÆ’â€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡ÃƒÃ‚Â¥ det er mere overskueligt.
