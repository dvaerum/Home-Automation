...
public class HelloBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements HelloVisitor<T> {
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitProgramtest(@NotNull HelloParser.ProgramtestContext ctx) { return visitChildren(ctx); }
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitTeststmts(@NotNull HelloParser.TeststmtsContext ctx) { return visitChildren(ctx); }
